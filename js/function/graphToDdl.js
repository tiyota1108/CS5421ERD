...
typeConversion.set("TEXT", "TEXT")
typeConversion.set("INT", "INT")
typeConversion.set("BIGINT", "BIGINT")
    ...
    for (let [key, values] of relationshipToEntity) {
        ...
        for (let i = 0; i < currRelationshipImplicitKeys.length; i++) {
            ...
            for (let j = 0; j < entityInfo.length; j++) {
                let keyName = entityName + "_" + entityInfo[j].name + "_" + i
